...
export class ProposalSubmitted extends DomainEvent {
    ...
    static with(proposalId: Id, client: Client, expectations: Expectations): ProposalSubmitted {
